...
adc_pins!(
    gpio::PA0<Analog> => (ADC1, 1),
    gpio::PA0<Analog> => (ADC2, 1),
    gpio::PA1<Analog> => (ADC1, 2),
    gpio::PA1<Analog> => (ADC2, 2),
    gpio::PA2<Analog> => (ADC1, 3),
    gpio::PA3<Analog> => (ADC1, 4),
    gpio::PA4<Analog> => (ADC2, 17),
    gpio::PA5<Analog> => (ADC2, 13),
    gpio::PA6<Analog> => (ADC2, 3),
    gpio::PA7<Analog> => (ADC2, 4),

    gpio::PB0<Analog> => (ADC1, 15),
    gpio::PB1<Analog> => (ADC1, 12),
    gpio::PB2<Analog> => (ADC2, 12),
    gpio::PB11<Analog> => (ADC1, 14),
    gpio::PB11<Analog> => (ADC2, 14),
    gpio::PB12<Analog> => (ADC1, 11),
    gpio::PB15<Analog> => (ADC2, 15),

    gpio::PC0<Analog> => (ADC1, 6),
    gpio::PC0<Analog> => (ADC2, 6),
    gpio::PC1<Analog> => (ADC1, 7),
    gpio::PC1<Analog> => (ADC2, 7),
    gpio::PC2<Analog> => (ADC1, 8),
    gpio::PC2<Analog> => (ADC2, 8),
    gpio::PC3<Analog> => (ADC1, 9),
    gpio::PC3<Analog> => (ADC2, 9),
    gpio::PC4<Analog> => (ADC2, 5),
    gpio::PC5<Analog> => (ADC2, 11),

    gpio::PF0<Analog> => (ADC1, 10),
    gpio::PF1<Analog> => (ADC2, 10),
...
adc_pins!(
    ...
    gpio::PA6<Analog> => (ADC2, 3),
    gpio::PA7<Analog> => (ADC2, 4),
    gpio::PA8<Analog> => (ADC5, 1),
    gpio::PA9<Analog> => (ADC5, 2),

    gpio::PB0<Analog> => (ADC3, 12),
    gpio::PB0<Analog> => (ADC1, 15),
    gpio::PB1<Analog> => (ADC3, 1),
    gpio::PB1<Analog> => (ADC1, 12),
    gpio::PB2<Analog> => (ADC2, 12),
    gpio::PB11<Analog> => (ADC1, 14),
    gpio::PB11<Analog> => (ADC2, 14),
    gpio::PB12<Analog> => (ADC4, 3),
    gpio::PB12<Analog> => (ADC1, 11),
    gpio::PB13<Analog> => (ADC3, 5),
    gpio::PB14<Analog> => (ADC4, 4),
    gpio::PB14<Analog> => (ADC1, 5),
    gpio::PB15<Analog> => (ADC4, 5),
    gpio::PB15<Analog> => (ADC2, 15),
    ...
    gpio::PE7<Analog> => (ADC3, 4),
    gpio::PE8<Analog> => (ADC3, 6),
    gpio::PE8<Analog> => (ADC4, 6),
    gpio::PE8<Analog> => (ADC5, 6),
    gpio::PE9<Analog> => (ADC3, 2),
    gpio::PE10<Analog> => (ADC3, 14),
    gpio::PE10<Analog> => (ADC4, 14),
    gpio::PE10<Analog> => (ADC5, 14),
    gpio::PE11<Analog> => (ADC3, 15),
    gpio::PE11<Analog> => (ADC4, 15),
    gpio::PE11<Analog> => (ADC5, 15),
    gpio::PE12<Analog> => (ADC3, 16),
    gpio::PE12<Analog> => (ADC4, 16),
    gpio::PE12<Analog> => (ADC5, 16),
    gpio::PE13<Analog> => (ADC3, 3),
    gpio::PE14<Analog> => (ADC4, 1),
    gpio::PE15<Analog> => (ADC4, 2),

    gpio::PD8<Analog> => (ADC4, 12),
    gpio::PD8<Analog> => (ADC5, 12),
    gpio::PD9<Analog> => (ADC4, 13),
    gpio::PD9<Analog> => (ADC5, 13),
    gpio::PD10<Analog> => (ADC3, 7),
    gpio::PD10<Analog> => (ADC4, 7),
    gpio::PD10<Analog> => (ADC5, 7),
    gpio::PD11<Analog> => (ADC3, 8),
    gpio::PD11<Analog> => (ADC4, 8),
    gpio::PD11<Analog> => (ADC5, 8),
    gpio::PD12<Analog> => (ADC3, 9),
    gpio::PD12<Analog> => (ADC4, 9),
    gpio::PD12<Analog> => (ADC5, 9),
    gpio::PD13<Analog> => (ADC3, 10),
    gpio::PD13<Analog> => (ADC4, 10),
    gpio::PD13<Analog> => (ADC5, 10),
    gpio::PD14<Analog> => (ADC3, 11),
    gpio::PD14<Analog> => (ADC4, 11),
    gpio::PD14<Analog> => (ADC5, 11),
