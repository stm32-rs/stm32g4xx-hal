...
opamps! {
    Opamp1 => opamp1: {
        vinm0: gpio::PA3<Analog>,
        vinm1: gpio::PC5<Analog>,
        inverting: {
            gpio::PA3<Analog>: Vinm0,
            gpio::PC5<Analog>: Vinm1,
        },
        non_inverting: {
            gpio::PA1<Analog>: Vinp0,
            gpio::PA3<Analog>: Vinp1,
            gpio::PA7<Analog>: Vinp2,
        },
        output: gpio::PA2<Analog>,
    },
    Opamp2 => opamp2: {
        vinm0: gpio::PA5<Analog>,
        vinm1: gpio::PC5<Analog>,
        inverting: {
            gpio::PA5<Analog>: Vinm0,
            gpio::PC5<Analog>: Vinm1,
        },
        non_inverting: {
            gpio::PA7<Analog>: Vinp0,
            gpio::PB14<Analog>: Vinp1,
            gpio::PB0<Analog>: Vinp2,
            gpio::PD14<Analog>: Vinp3,
        },
        output: gpio::PA6<Analog>,
    },
    Opamp3 => opamp3: {
        vinm0: gpio::PB2<Analog>,
        vinm1: gpio::PB10<Analog>,
        inverting: {
            gpio::PB2<Analog>: Vinm0,
            gpio::PB10<Analog>: Vinm1,
        },
        non_inverting: {
            gpio::PB0<Analog>: Vinp0,
            gpio::PB13<Analog>: Vinp1,
            gpio::PA1<Analog>: Vinp2,
        },
        output: gpio::PB1<Analog>,
    },
}
...
opamps! {
    ...
    Opamp6 => opamp6: {
        vinm0: gpio::PA1<Analog>,
        vinm1: gpio::PB1<Analog>,
        inverting: {
            gpio::PA1<Analog>: Vinm0,
            gpio::PB1<Analog>: Vinm1,
        },
        non_inverting: {
            gpio::PB12<Analog>: Vinp0,
            gpio::PD9<Analog>: Vinp1,
            gpio::PB13<Analog>: Vinp2,
        },
        output: gpio::PB11<Analog>,
    },
}
...
opamps! {
    ...
    Opamp4 => opamp4: {
        vinm0: gpio::PB10<Analog>,
        vinm1: gpio::PD8<Analog>,
        inverting: {
            gpio::PB10<Analog>: Vinm0,
            gpio::PD8<Analog>: Vinm1,
        },
        non_inverting: {
            gpio::PB13<Analog>: Vinp0,
            gpio::PD11<Analog>: Vinp1,
            gpio::PB11<Analog>: Vinp2,
        },
        output: gpio::PB12<Analog>,
    },
    Opamp5 => opamp5: {
        vinm0: gpio::PB15<Analog>,
        vinm1: gpio::PA3<Analog>,
        inverting: {
            gpio::PB15<Analog>: Vinm0,
            gpio::PA3<Analog>: Vinm1,
        },
        non_inverting: {
            gpio::PB14<Analog>: Vinp0,
            gpio::PD12<Analog>: Vinp1,
            gpio::PC3<Analog>: Vinp2,
        },
        output: gpio::PA8<Analog>,
    },
    Opamp6 => opamp6: {
        vinm0: gpio::PA1<Analog>,
        vinm1: gpio::PB1<Analog>,
